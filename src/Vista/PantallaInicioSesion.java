...
public class PantallaInicioSesion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        usuarioTextField.setName("usuario_textbox"); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(contraseñaTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(usuarioTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 1, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(botonIniciarSesion, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void botonIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonIniciarSesionActionPerformed
        ...
        try {
            acceso = sesion.iniciarSesion(usuarioTextField.getText(), contraseñaTextField.getText());
        ...
        if (acceso) {
            ...
            try {
                roles = sesion.obtenerRolesUsuario(usuarioTextField.getText());
            } catch (SQLException ex) {
                Logger.getLogger(PantallaInicioSesion.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            try {
                pantallaPrincipal = new PantallaPrincipal(usuarioTextField.getText(), roles, labelRoles);
            } catch (SQLException ex) {
                Logger.getLogger(PantallaInicioSesion.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            JOptionPane.showMessageDialog(this,
                "Inicio de sesión incorrecto. Intente nuevamente.",
                "Algo ha salido mal",
